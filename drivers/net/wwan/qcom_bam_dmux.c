...
enum {
	...
	BAM_DMUX_CH_DATA_6,
	BAM_DMUX_CH_DATA_7,
	BAM_DMUX_CH_USB_RMNET_0,	/* 8 */
	BAM_DMUX_CH_RESERVED_0,		/* 9 */
	BAM_DMUX_CH_RESERVED_1,		/* 10 */
	BAM_DMUX_CH_RESERVED_2,		/* 11 */
	BAM_DMUX_CH_DATA_REV_0,		/* 12 */
	BAM_DMUX_CH_DATA_REV_1,		/* 13 */
	BAM_DMUX_CH_DATA_REV_2,		/* 14 */
	BAM_DMUX_CH_DATA_REV_3,		/* 15 */
	BAM_DMUX_CH_DATA_REV_4,		/* 16 */
	BAM_DMUX_CH_DATA_REV_5,		/* 17 */
	BAM_DMUX_CH_DATA_REV_6,		/* 18 */
	BAM_DMUX_CH_DATA_REV_7,		/* 19 */
	BAM_DMUX_CH_DATA_REV_8,		/* 20 */
	BAM_DMUX_CH_USB_DPL,		/* 21 */
	BAM_DMUX_NUM_CH
};
...
static int bam_dmux_probe(struct platform_device *pdev)
{
	...
	/* A2 BAM only generates 32-bit DMA addresses */
